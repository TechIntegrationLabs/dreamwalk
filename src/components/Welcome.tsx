    ...
    <section className="relative py-16 sm:py-24 bg-black">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <div className="inline-block px-4 sm:px-8 py-3 sm:py-4 rounded-2xl bg-gradient-to-r from-purple-900/50 to-pink-900/50 border border-purple-500/30 mb-6 sm:mb-8">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-200 to-pink-200 tracking-tight">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16">
          ...
          <p className="text-base sm:text-lg text-gray-300 mb-4 sm:mb-6 leading-relaxed px-4">
        ...
        <div className="max-w-2xl mx-auto px-4">
          <div className="bg-gray-900/80 rounded-2xl p-6 sm:p-8 backdrop-blur-sm border border-purple-500/20">
